...
<div class="login-wrapper ">
  ...
  <div class="login-container bg-white">
    ...
    <?php echo form_open('auth/reset_password/'.$code, 'class="form-stacked"');?>
      <div class="p-l-20 p-r-20 p-t-50 sm-p-l-15 sm-p-r-15">
        <div class="text-center"><img src="<?php echo base_url();?>assets/img/simdiklat-login-logo.png" width="456px">
        </div>
        <p class="p-t-35">Masukan password baru anda.</p>
        <!-- START Login Form -->
          <!-- START Form Control-->
          ...
          <div class="row">
            <div class="col-md-6 col-xs-6">
              <?php echo anchor('auth/login','Back','class="btn yellow btn-outline"')?>
              <button type="submit" class="btn green text-right">Submit</button>
            </div>
          </div>
      </div>
    </form>
