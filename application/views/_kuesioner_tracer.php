										<div class="row">
											<div class="col-md-12">
												<div class="portlet light bordered">
													...
													<?php echo form_open('home','role="form" class="form-horizontal" id="myForm"');?><br />
														<ul class="nav nav-tabs">
															<li class="active">
																<a href="#tab_1_1" data-toggle="tab"> I. Identitas </a>
															</li>
															<li>
																<a href="#tab_1_2" data-toggle="tab"> II. Transisi Kepegawaian </a>
															</li>
															<li>
																<a href="#tab_1_3" data-toggle="tab"> III. Pendapatan/Penghasilan </a>
															</li>
															<li>
																<a href="#tab_1_4" data-toggle="tab"> IV. Pengalaman Training </a>
															</li>
															<li>
																<a href="#tab_1_5" data-toggle="tab"> V. Kesempatan dalam Program Gelar </a>
															</li>
														</ul>
														<div class="tab-content">
															<div class="tab-pane fade active in " id="tab_1_1">
																...
																<div class="form-actions fluid">
																	<div class="row">
																		<div class="col-md-12">
																			<a class="btn btn-primary btnNext pull-right" >Selanjutnya <i class="fa fa-arrow-right"></i></a>
																		</div>
																	</div>
																</div>
															</div>
															<div class="tab-pane fade" id="tab_1_2">
																...
																<div class="form-actions fluid">
																	<div class="row">
																		<div class="col-md-12">
																			<a class="btn green btnPrevious pull-left" ><i class="fa fa-arrow-left"></i> Sebelumnya</a>
																			<a class="btn btn-primary btnNext pull-right" >Selanjutnya <i class="fa fa-arrow-right"></i></a>
																		</div>
																	</div>
																</div>
															...
															<div class="tab-pane fade" id="tab_1_5">
																...
																<div class="form-actions fluid">
																	<div class="row">
																		<div class="col-md-12">
																		<?php if($submit){?>
																			<button type="submit" class="pull-right btn btn-md btn-primary"><i class="fa fa-save"></i> Simpan</button>
																			<a class="btn green btnPrevious pull-left" ><i class="fa fa-arrow-left"></i> Sebelumnya</a>
																		<?php }else{ ?>
