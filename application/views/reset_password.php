...
<html lang="en">
    ...
    <body class=" login">
        ...
        <div class="content">
            <!-- BEGIN LOGIN FORM -->
            <?php echo form_open("auth/reset-password", 'class="form-stacked"');?>
                ...
                <div class="form-group">
                    ...
                    <div class="input-icon">
						...
						<input type="email" name="email" placeholder="ALamat Email" value="" class="form-control" required>
					</div>
                </div>
                <div class="form-actions">
					<button type="submit" class="btn btn-primary"> Kirim </button>
					<?php echo anchor('auth/login','Kembali', 'class="pull-right"');?>
				</div>
            </form>
            <!-- END LOGIN FORM -->
		</div>
